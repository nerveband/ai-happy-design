...
/** Does not display units, even if show-units is on. */
	...
	/** Internal */
	kADMMaxNormalUnits = kADMFeetUnits, /*kADMFeetUnits, Modifying this as given in the comment above*/
