...
#define kAIArtboardSuiteVersion			AIAPI_VERSION(9)
...
struct AIArtboardSuite{
	...
	*/
	...
	AIAPI AIErr (*GetLocked)(const ai::ArtboardProperties& artboardList, AIBoolean& isLocked);
    AIAPI AIErr (*SetLocked)(ai::ArtboardProperties& artboardList, const AIBoolean& isLocked);

    AIAPI AIErr (*GetHide)(const ai::ArtboardProperties& artboardList, AIBoolean& isHidden);
    AIAPI AIErr (*SetHide)(ai::ArtboardProperties& artboardList, const AIBoolean& isHidden);
};
