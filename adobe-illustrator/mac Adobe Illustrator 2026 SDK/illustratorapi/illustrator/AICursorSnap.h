...
/** @ingroup Suites
	...
	@note The Snap to Grid feature now coexists with Object Smart Guides, showing
    snap annotations to gridlines in addition to objects. When Force Snap to Grid is
    enabled, snapping is restricted exclusively to gridlines.
	...
	/** Reports whether Smart Guides should be used to snap the
		...
		a Boolean value, not an error code.)
			...
			@return True if Smart Guides should be used. 
                    It will return true when either Smart Guides is enabled
                    OR Snap to Grid is enabled
	 */
		...
		the "Snap To Point" application preference.
			...
			@param control How snapping is performed, a string containing
				...
				\li An uppercase character enables a constraint:
                    ...
                    - G: Enable snapping to the Grid lines.
