...
#define kAIDocumentListSuiteVersion12	AIAPI_VERSION(12)

// latest version
#define kAIDocumentListSuiteVersion		kAIDocumentListSuiteVersion12
...
struct AINewDocumentPreset {
	...
	AIColor				docArtboardBackgroundColor{kNoneColor, {}};
};
