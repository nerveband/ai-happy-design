...
typedef enum AIFolderType
{
		...
		kAIExportPresetFolderType=120,
		kAIModifiedPDFPresetFolderType=121,
		kAIApplicationSupportCommonIllustratorFolderType = 122,
		kAIOnDemandModulesRootFolderType = 123,
		kCCXPWelcomeFolderType = 124,
		kAIUserWritablePresetUserMockupFolderType = 125,
		kAIDvaLogsFolderType = 126,
		kAIIllustratorDiagnosysPrefsFolderType = 127,
		kAIPreferencesCommonRootFolderType = 128
} AIFolderType;
