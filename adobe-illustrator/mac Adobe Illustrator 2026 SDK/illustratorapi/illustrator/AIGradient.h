...
#define kAIGradientSuiteVersion11	AIAPI_VERSION(11)
/** Gradient suite version */
#define kAIGradientSuiteVersion		kAIGradientSuiteVersion11
/** Gradient suite version */
...
typedef struct {
	...
	*/
	...
	/* New in Illustrator 30.1 - Version 11 */
	/** Sets the Dithering property of a gradient and applies it to the specified art object to which the gradient belongs.
			@param art The art object to which the gradient belongs.
			@param gradient The gradient object.
			@param isDither When true, enables dithering for the gradient.
		*/
	AIAPI AIErr (*SetGradientDitherProperty) ( AIArtHandle art, AIGradientHandle gradient, AIBoolean isDither );
