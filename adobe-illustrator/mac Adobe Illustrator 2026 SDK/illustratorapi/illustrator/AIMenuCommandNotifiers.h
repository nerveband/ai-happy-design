...
#define kAISnappingOnOffMenuItemCommandPreNotifierStr                "AI Command Notifier: Enable/Disable SnappingRoot"      //View:Smart Guides
#define kAISnappingOnOffMenuItemCommandPostNotifierStr               "AI Command Notifier: Enable/Disable SnappingRoot"       //View:Smart Guides
...
#define kAIAdobeHistoryPanelCommandPostNotifierStr                   "AI Command Notifier: After Adobe History Panel"               //Window:History Panel
#define kAIAdobeHistoryPanelCommandPreNotifierStr                    "AI Command Notifier: Before Adobe Stroke Palette"             //Window:History Panel
