...
#define kAIPathSuiteVersion13	AIAPI_VERSION(13)
#define kAIPathSuiteVersion		kAIPathSuiteVersion13
...
struct AIPathSuite {
	...
	*/
	...
	/** Reports selection state of path segments.
			@param path The path object.
			@param segNumber The 0-based index of the first segment.
		...
		*/
	AIAPI AIErr (*GetPathSegmentsSelected) ( AIArtHandle path, ai::int16 segNumber, ai::int16 count, ai::int16 selected[] );
	...
	/** Sets the selection state for path segments.
			@param path The path object.
			@param segNumber The 0-based index of the first segment.
			...
			@note Modifying the selection state of one segment can affect
				...
				is selected, the in direction of the following segment is also selected.
		*/
	AIAPI AIErr (*SetPathSegmentsSelected) ( AIArtHandle path, ai::int16 segNumber, ai::int16 count, const ai::int16 selected[] );
	...
	/** Sets the selection state for all segments of a path.
			@param path The path object.
			...
			@note Modifying the selection state of one segment can affect
				...
				is selected, the in direction of the following segment is also selected.
		*/
	AIAPI AIErr (*SetPathAllSegmentsSelected) ( AIArtHandle path, ai::int16 selected );
