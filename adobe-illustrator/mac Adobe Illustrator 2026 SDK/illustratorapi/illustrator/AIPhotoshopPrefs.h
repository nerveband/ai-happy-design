...
struct PSDImportUIParams
{
    PSDImportUIParams(bool flattenLayers, bool importHiddenLayers)
    : mFlattenLayers(flattenLayers)
    , mImportHiddenLayers(importHiddenLayers)
    {}
    
    AIBoolean mFlattenLayers;
    AIBoolean mImportHiddenLayers;
};
