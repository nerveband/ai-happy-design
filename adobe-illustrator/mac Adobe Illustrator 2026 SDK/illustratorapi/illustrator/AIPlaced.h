...
#define kAIPlacedSuiteVersion11		AIAPI_VERSION(11)
#define kAIPlacedSuiteVersion		kAIPlacedSuiteVersion11
...
typedef struct AIPlacedSuite {
	...
	*/
    ...
    /* Check if Placed Linked Object File uses proxy for rendering.
        @param art The placed object.
    */
    AIAPI AIBoolean(*IsProxyUsedForRendering) (AIArtHandle art);
