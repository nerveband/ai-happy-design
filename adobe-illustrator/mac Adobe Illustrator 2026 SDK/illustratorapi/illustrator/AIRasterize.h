...
enum AIRasterizeOptions {
	...
	/** [Internal] When set, use shared space to store the user rasterize image*/
	kRaterizeSharedSpace = 1<<11,
	/** When set, use nearest neighbor sampling for gradient dither images instead of averaging */
	kRasterizeGradientDither = 1<<12
};
