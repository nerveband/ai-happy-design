...
enum class AISelectionContextFlags : ai::uint16
{
	...
	*/
    ...
    /**
	* To find if a current selection has slice object in it.
	*/
    kAISelectionHasSlice,
	...
	*/
    ...
    /**
    * To find if a intertwine context is present in the current selection.
    */
    kAISelectionHasIntertwine,
    kAISelectionHasMultipleIntertwine,
    
    /**
    * To find if a VectorEdge context is present in the current selection.
    */
    kAISelectionHasVectorEdge,
    kAISelectionHasMultipleVectorEdge,

    /**
	* To find if multiple embedded images are present in the current selection.
	*/
    kAISelectionHasMultipleEmbedImageArt,

    /**
    * To find if a dimension context is present in the current selection.
    */
    kAISelectionHasDimension,
    kAISelectionHasMultipleDimension,

    /**
    * To find if a ContraintGroup context is present in the current selection.
    */
    kAISelectionHasConstraintGroup,
    kAISelectionHasMultipleConstraintGroup,
    
    /**
    * To find if a ContraintGroup context is present in the current selection.
    */
    kAISelectionHasSwatchesGroup,
    kAISelectionHasMultipleSwatchesGroup
