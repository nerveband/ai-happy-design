...
/**
 * Interpolation type for smooth shading styles
 */
 enum InterpolationType
 {
     Classic = 0,        ///< Classic interpolation method
     Perceptual = 1      ///< Perceptual interpolation method
 };
 
 // Default interpolation type
 constexpr InterpolationType kDefaultInterpolationType = InterpolationType::Classic;
...
struct AISmoothShadingStyle
{
    ...
    InterpolationType interpolationType = kDefaultInterpolationType;
