...
#define kAISwatchGroupSuiteVersion4			AIAPI_VERSION(4)
#define kAISwatchGroupSuiteVersion			kAISwatchGroupSuiteVersion4
...
enum AIRequiredSwatchTypes : ai::uint16
{
	kAISolidsOnly = 1,
	kAIPatternsOnly = 2,
	kAIGradientsOnly = 4
...
typedef struct {
	...
	/** Sets the kind of a swatch group.
			@param swatchGroup The swatch group object.
			@param name The new Kind.
		*/
	ASErr ASAPI (*SetSwatchGroupKind) (AISwatchGroupRef swatchGroup, AISwatchGroupKind groupKind);
	...
	*/
	...
	ASErr ASAPI (*FilterSwatchGroup)(AISwatchGroupRef swatchGroup, ai::int32 swatchType, std::vector<AISwatchRef>& filteredGroup);
