...
#define kAIUnicodeStringSuiteVersion		AIAPI_VERSION(10)
...
struct AIUnicodeStringSuite
{
	...
	/** Compares two Unicode strings. Uninitialized strings are equal to other uninitialized
		strings and empty strings, and are less than initialized, non-empty strings.
		(Note that this function returns a numeric value, not an error code.)
			...
			@return 0 if the strings are equal.
				<br> Positive if the first string is greater than the second.
				<br> Negative if the second string is greater than the first.
		*/
	...
	/** Compares substrings in two Unicode strings. Uninitialized strings
		...
		*/
	AIAPI ai::int32 (*CompareSubString) (const ai::UnicodeString& str,
    ...
    */
	...
	/** Performs a caseless comparison of two Unicode strings.
	...
	/** Performs a caseless comparison of substrings in two Unicode strings.
		...
		(Note that this function returns a numeric value, not an error code.)
			...
			@return 0 if the substrings are equal.
				...
				<br> Negative if the second substring is greater than the first.
			*/
	AIAPI ai::int32 (*CaseCompareSubString) (const ai::UnicodeString& str,
		ai::UnicodeString::size_type pos, ai::UnicodeString::size_type num,
		const ai::UnicodeString& str2,
		ai::UnicodeString::size_type startOffset, ai::UnicodeString::size_type count);
