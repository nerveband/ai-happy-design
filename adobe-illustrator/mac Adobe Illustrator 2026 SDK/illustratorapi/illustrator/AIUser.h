...
#define kAIUserSuiteVersion21		AIAPI_VERSION(21)
#define kAIUserSuiteVersion			kAIUserSuiteVersion21
...
struct AIUserSuite {
	...
	*/
    ...
    /** Launches the appropriate application to edit/open file specefied via custom URI scheme
    @param customUri The custom uri
    @param appPath The App Executable location to be used for opening the uri
    @return \c #kApplicationNotFoundErr error if the application is not found.
    */
    AIAPI AIErr (*LaunchCustomAppForCustomUri)(const ai::UnicodeString& customUri, const ai::FilePath& appPath);
