...
#define kAIVectorizeSuiteVersion		AIAPI_VERSION(2)
...
/** @ingroup Notifiers
	Sent to indicate the occurence of tracing
  	Message data contains the Vectorize object being updated. */
#define kAIVectorizeTraceOccurenceNotifier			"AI Vectorize Trace Occurence Notifier"
...
/** Tracing option key for whether to enable gradients or not.  Boolean. */
#define kTracingEnableGradientKey           "adobe/vectorize/ip/enableGradient"

/** @ingroup DictKeys
    Tracing option key for fetching gradient slider value. Float*/
#define kTracingGradientFidelityKey         "adobe/vectorize/ip/GradientFidelity"
...
/** Tracing option key to enable live text creation.  Boolean. */
#define kTracingCreativeLiveTextKey            "adobe/vectorize/output/createLiveText"

/** Tracing option key for whether to simplify path geometry or not.  Boolean. */
#define kTracingShouldSimplifyKey            "adobe/vectorize/output/shouldSimplify"

/** Tracing option key for curve precision parameter for simplify.  Double-precision-floating-point. */
#define kTracingSimplfyCurvePrecisionKey     "adobe/vectorize/output/simplifyCurvePrecision"

#define kTracingSnapCurvesToLinesKey		"adobe/vectorize/output/snapcurvestolines"

#define kTracingIsAlphaEnabledUIKey			"adobe/vectorize/output/alphaEnabledUI"

#define kTracingIsAlphaEnabledKey	"adobe/vectorize/output/alphaEnabled"

#define kTracingAlphaColorKey				"adobe/vectorize/output/alphaColor"

/** @ingroup DictKeys
	Tracing option key for parent of custom preset. String. */
#define kTracingParentOfCustomPresetKey					"adobe/vectorize/parentOfCustomPreset"
...
/** @ingroup DictKeys
	Tracing statistics key for number of gradients used. Long.  */
#define kTracingGradientCountKey				"adobe/vectorize/statistics/gradientcount"
/** @ingroup DictKeys
Key for the classifier class dictionary for tracing. See \c #AIVectorizeSuite. */
#define kTracingImageClassKey				"adobe/vectorize/imageclass"
/** @ingroup DictKeys
	Tracing cache key for LiveText top level group object created through retype. Group art object. */
#define kTracingLiveTextGroupArtKey			"adobe/vectorize/livetext/group"

/** @ingroup DictKeys
	Tracing option key for whether to create live shapes or not.  Boolean. */
#define kTracingFitLiveShapesKey		"adobe/vectorize/in/fitliveshapes"

/** @ingroup DictKeys
	Tracing option key for whether to auto grouping is enabled or not.  Boolean. */
#define kTracingAutoGroupingKey		"adobe/vectorize/in/autogrouping"
...
#define kTracingEnableGradientDefault       (false)
#define kTracingGradientMinFidelityDefault  (0.0f)
...
#define kTracingGradientFidelityDefault     (50.0f)
...
#define kShouldIgnoreColorDefault			(false)
#define kTracingSnapCurvesToLinesDefault	(false)
#define kTracingAlphaDefaultUI				(false)
#define kTracingAlphaDefault		(false)
#define kTracingFitLiveShapesDefault		(false)
#define kTracingAutoGroupingDefault			(false)
...
#define kTracingShouldSimplifyDefault          (false)
#define kTracingSimplifyCurvePrecisionDefault  (90.0)

#define kTracingCreateLiveTextDefault          (false)
...
const char* const kTracingPresetsProteusSketch   = "$$$/Tracing/Str/Options/ProteusSketch=Sketch";
const char* const kTracingPresetsProteusLineArt   = "$$$/Tracing/Str/Options/ProteusLineArt=Line Art";
const char* const kTracingPresetsProteusLogo   = "$$$/Tracing/Str/Options/ProteusLogo=Logo";
const char* const kTracingPresetsProteusPainting   = "$$$/Tracing/Str/Options/ProteusPainting=Painting";
const char* const kTracingPresetsProteusPhotograph   = "$$$/Tracing/Str/Options/ProteusPhotograph=Photograph";

const char* const kProteusCustomPresetStr = "$$$/Vectorize/ProteusCustomPreset=Custom";
...
typedef struct {
	...
	/** Retrieves the image classifier output class of an art object.
			@param art The art object, typically a tracing group, raster, or foreign object.
			@param imageClass [out] A buffer to populate classifier output class.
		*/
	AIAPI AIErr (*GetImageClass) (AIArtHandle art, ai::int32 &imageClass);
	
	/** Retrieves the image classifier output class mapped preset string for an art object.
			@param art The art object, typically a tracing group, raster, or foreign object.
			@param presetStr [out] Classifier output as preset string.
		*/
	AIAPI AIErr (*GetImageClassPresetStr) (AIArtHandle art, ai::UnicodeString &presetStr);
