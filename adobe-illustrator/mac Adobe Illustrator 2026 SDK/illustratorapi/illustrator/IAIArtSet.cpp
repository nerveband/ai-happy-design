...
namespace ai
{
	...
	public:
		...
		AIErr GenerateForTopLevelLayersEx(bool skipHiddenLayers, bool skipTemplateLayers);
		AIErr GenerateForNthArtboardEx(ai::ArtboardID inArtboardIndex, bool skipHiddenArts, bool skipTemplateLayers);
	...
	AIErr ArtSet::Impl::GenerateForNthArtboardEx(ai::ArtboardID inArtboardIndex, bool skipHiddenArts, bool skipTemplateLayers)
	{
		mLastError = sAIArtSetGenerator->GenerateForNthArtboardEx(inArtboardIndex, mArtSet, skipHiddenArts, skipTemplateLayers);
		return mLastError;
	}
	...
	AIErr ArtSet::Impl::GenerateForTopLevelLayersEx(bool skipHiddenLayers, bool skipTemplateLayers)
	{
		mLastError = sAIArtSetGenerator->GenerateForTopLevelLayersEx(mArtSet, skipHiddenLayers, skipTemplateLayers);
		return mLastError;
	}
	...
	AIErr ArtSet::GenerateForNthArtboardEx(ai::ArtboardID inArtboardIndex, bool skipHiddenArts, bool skipTemplateLayers)
	{
		return pImpl->GenerateForNthArtboardEx(inArtboardIndex, skipHiddenArts, skipTemplateLayers);
	}
	...
	AIErr ArtSet::GenerateForTopLevelLayersEx(bool skipHiddenLayers, bool skipTemplateLayers)
	{
		return pImpl->GenerateForTopLevelLayersEx(skipHiddenLayers, skipTemplateLayers);
	}
