...
ASErr ai::ColorSpace::GetFamilyAsStr( ai::UnicodeString& familyStr) const noexcept
{
	ASErr				result = kNoErr;

	switch (this->GetFamily())
	{
	case ai::ColorSpace::kAIColorSpaceFamilyGray:
		familyStr = ai::UnicodeString::FromRoman("Grayscale");
		break;
	case ai::ColorSpace::kAIColorSpaceFamilyRGB:
		familyStr = ai::UnicodeString::FromRoman("RGB");
		break;
	case ai::ColorSpace::kAIColorSpaceFamilyCMYK:
		familyStr = ai::UnicodeString::FromRoman("CMYK");
		break;
	case ai::ColorSpace::kAIColorSpaceFamilyLab:
		familyStr = ai::UnicodeString::FromRoman("Lab");
		break;
	case ai::ColorSpace::kAIColorSpaceFamilySeparation:
		familyStr = ai::UnicodeString::FromRoman("Separation");
		break;
	case ai::ColorSpace::kAIColorSpaceFamilyNChannel:
		familyStr = ai::UnicodeString::FromRoman("DeviceN");
		break;
	case ai::ColorSpace::kAIColorSpaceFamilyIndexed:
		familyStr = ai::UnicodeString::FromRoman("Indexed");
		break;
	default:
