...
*/
	...
	public:
		...
		/**
			Release ownership of an entry and now caller will have responsibility to release it.
			Added this only for compatibility with some existing APIs. New code should avoid it. 
		*/
		AIEntryRef release() const;
	...
	public:
		...
		//moves an entry from another (or this) array to this array
		void move_entry(ai::Array& srcArr, ai::int32 srcArrIndex, ai::int32 dstArrIindex);

		//swaps entries between different (or same) array
	...
	public:
        ...
        // Get NonRecordedDictionary from given document
        static ai::Dictionary GetDocumentNonRecordedDictionary(AIDocumentHandle docHandle);
