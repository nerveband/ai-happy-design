...
#ifdef WIN_ENV
constexpr ai::uint32 MaxPath = 259;
#endif
#ifdef MAC_ENV
constexpr ai::uint32 MaxPath = 1023;
#endif
#ifdef LINUX_ENV
const ai::uint32 MaxPath = PATH_MAX;
#endif

constexpr ai::uint32 MaxFile = 255;
...
class FilePath
{
	...
	/** Creates as initialized file-path object from a file reference.
