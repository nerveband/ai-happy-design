...
{
	ai::int32 result = sAIUnicodeString->Compare(*this, str);
	return result;
}
...
{
	ai::int32 result = sAIUnicodeString->CompareSubString(*this, pos, num, str, 0, str.length());
	return result;
}
...
{
	ai::int32 result = sAIUnicodeString->CompareSubString(*this, pos, num, str, startOffset, count);
	return result;
}
...
ai::int32 ai::UnicodeString::caseCompare (const UnicodeString& str) const
{
	ai::int32 result = sAIUnicodeString->CaseCompare(*this, str);
	return result;
}
...
ai::int32 ai::UnicodeString::caseCompare (ai::UnicodeString::size_type pos,
								...
								ai::UnicodeString::size_type startOffset, ai::UnicodeString::size_type count) const
{
	ai::int32 result = sAIUnicodeString->CaseCompareSubString(*this, pos, num, str, startOffset, count);
	return result;
}
