...
#if defined(MAC_ENV)
/** Internal */
struct AICatalogInfo;
typedef SPAPI void (*SPGetBundleFromPluginAsyncLoadCacheProc)(const char* filepath, CFBundleRef& outBundle, AICatalogInfo& outCatalogInfo);
#endif	// MAC_ENV
#if defined(WIN_ENV)
/** Internal */
typedef SPAPI HINSTANCE (*SPGetHInstanceForPluginAsyncLoadCacheProc)(const char* pluginName);
#endif	// WIN_ENV
/** Internal */
typedef SPAPI SPEntry (*SPGetPluginEntryPointFromPluginAsyncLoadCacheProc)(const char* pluginName);
...
typedef SPAPI void(*SPLogToDataCollector)(void *hostLogData, const char* logString1, const char* logString2);
...
/** Dynamic Plugin Startup Order hardening */
typedef SPAPI void(*ReorderPluginsListForStartupProc)();
...
typedef struct SPHostProcs {
...
#if defined(MAC_ENV)
	SPGetBundleFromPluginAsyncLoadCacheProc getBundleFromPluginAsyncLoadCache;
#endif	// MAC_ENV
#if defined(WIN_ENV)
	SPGetHInstanceForPluginAsyncLoadCacheProc getHInstanceForPluginAsyncLoadCache;
#endif	// WIN_ENV
	SPGetPluginEntryPointFromPluginAsyncLoadCacheProc getPluginEntryPointFromPluginAsyncLoadCache;
	...
	SPLogToDataCollector logToDataCollector;
#endif	// SPPerfLoggingEnabled

	ReorderPluginsListForStartupProc reorderPluginsListForStartupProc;
} SPHostProcs;
