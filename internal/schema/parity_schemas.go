...
func init() {
	...
	for _, s := range []Schema{
		...
		{Command: "text.get_content", Description: "Get text content", Params: []Param{nodeID}},
		{Command: "text.get_segments", Description: "Get styled text segments", Params: []Param{nodeID}},
